<?php
// DEBUG (pode comentar depois que estiver tudo certo)
...
// BUSCAR VEÍCULO ATIVO PELA PLACA
$stmt = $pdo->prepare("
    SELECT * 
...
if (!$veiculo) {
    // NENHUM VEÍCULO ENCONTRADO → MOSTRA TELA BONITA, NÃO DIE SECO
    ?>
    <!DOCTYPE html>
    <html lang="pt-br">
    <head>
    ...
    <div class="container">
        <div class="card">
            ...
            <p>Nenhum veículo <strong>ativo</strong> foi localizado para a placa:</p>
            <p style="font-size: 1.2rem; margin-top: 8px;">
                <strong><?php echo htmlspecialchars($placa_original ?: $placa); ?></strong>
            </p>
            <br>
...
// SE CHEGOU AQUI, TEM VEÍCULO ATIVO
