...
// Compatibilidade: se em algum lugar antigo usarem 'usuario_perfil'
if (!isset($_SESSION['user_perfil']) && isset($_SESSION['usuario_perfil'])) {
    $_SESSION['user_perfil'] = $_SESSION['usuario_perfil'];
}
...
if ($_SESSION['user_perfil'] !== 'ADMIN') {
    ...
    echo "<p>Perfil atual: " . htmlspecialchars($_SESSION['user_perfil']) . "</p>";
